...
def query(request):
	...
	# send request.body contains [currentQuery, currentTitle, currentKeyWords, [formerQuery, formerTitle, formerKeywords], eachResult[rank, pointer, evalvalue], [assessorName, assessorGroup]]
