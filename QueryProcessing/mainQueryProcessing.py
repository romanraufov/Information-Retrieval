...
# local import
sys.path.insert(0, '../TextProcessing/Indexing')
...
# load dict
def getDict():
    path2dict = "../TextProcessing/Indexing/MultipleIndexLogFiles/MainIndexFile/MainIndex_Complete_2019-03-17.pkl"
    pickle_in = open(path2dict,"rb")
    return pickle.load(pickle_in)

def getTitleDict():
    path2dict = "../TextProcessing/Indexing/MultipleIndexLogFiles/MainIndexFile/TitleIndex_Complete_2019-03-17.pkl"
    pickle_in = open(path2dict,"rb")
    return pickle.load(pickle_in)
